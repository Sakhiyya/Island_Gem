...
export default function AuthorityLogin() {
  ...
  return (
    <div className="split-layout" style={{ display: "flex", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Left panel */}
      <div className="split-left" style={{ flex: 1, background: "linear-gradient(135deg, #0f172a 0%, #1e293b 60%, #1e3a5f 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "60px 48px" }}>
